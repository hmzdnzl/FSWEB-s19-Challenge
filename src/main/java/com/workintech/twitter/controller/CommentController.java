...
public class CommentController {
    ...
    @GetMapping("/{id}")
    public CommentResponseDto findById(@PathVariable("id") Long id) {
    ...
    @PutMapping("/{id}")
    public CommentResponseDto replaceOrCreate(@PathVariable("id") Long id, @RequestBody CommentRequestDto commentRequestDto ) {
        return commentService.replaceOrCreate(id, commentRequestDto);
    }

    @PatchMapping("/{id}")
    public CommentResponseDto update(@PathVariable("id") Long id, @RequestBody CommentPatchRequestDto commentPatchRequestDto ) {
